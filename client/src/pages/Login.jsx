        ...
        <div className="min-h-screen flex items-center justify-center p-4 sm:p-6">
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 mt-2 text-sm sm:text-base">Sign in to access your notes</p>
                </div>
                ...
                <p className="text-center mt-8 text-slate-500 dark:text-slate-400">
                    Don't have an account? <Link to="/signup" className="text-primary-600 hover:underline font-medium">Create one</Link>
                </p>
            </motion.div>
        </div>
    );
